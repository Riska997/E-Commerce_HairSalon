...
CREATE TABLE IF NOT EXISTS messages ( MessageID INT AUTO_INCREMENT PRIMARY KEY, CustomerName VARCHAR(100) NOT NULL, Email VARCHAR(100) NOT NULL, Phone VARCHAR(20) NOT NULL, Message TEXT NOT NULL, Status ENUM('Pending', 'Responded') DEFAULT 'Pending', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP );